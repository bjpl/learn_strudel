#!/usr/bin/env python3
"""
Generate Latin Melodic Composition - Fixed Version
==================================================
"""
...
def generate_latin_composition():
    """Generate the complete Latin melodic composition"""

    composition_code = """// Beautiful Latin Melodic Composition
...
composition"""
    ...
    output_file = Path("latin_melodic_piece.js")
    output_file.write_text(composition_code)
    print(f"✅ Created: {output_file}")

    # Create a simpler test version
    simple_code = """// Simple Latin Test Pattern
...
.room(0.3)"""
    ...
    test_file = Path("test_latin_simple.js")
    test_file.write_text(simple_code)
    print(f"✅ Created: {test_file} (simple test version)")

    # Create README
    readme = """# Latin Melodic Composition

## 🎵 Beautiful 1-Minute Latin Piece

### Files:
- `latin_melodic_piece.js` - Full composition
- `test_latin_simple.js` - Simple test pattern

### How to Play:
1. Open the .js file in a text editor
2. Copy all the code
3. Go to https://strudel.cc/
4. Paste the code
5. Press Ctrl+Enter (or Cmd+Enter on Mac)

### Musical Elements:
- **Rhythm**: Authentic Latin clave pattern
- **Melody**: A harmonic minor scale
- **Tempo**: 120 BPM
- **Duration**: ~60 seconds

Enjoy your Latin composition! 🎶"""
...
if __name__ == "__main__":
    print("\n🎼 GENERATING LATIN COMPOSITION FILES")
    print("=" * 50)

    success = generate_latin_composition()

    if success:
        print("\n✨ SUCCESS! Files created:")
        print("   • latin_melodic_piece.js")
        print("   • test_latin_simple.js")
        print("   • README.md")
        print("\n🎹 Copy the code to https://strudel.cc/ to play!")
    else:
        print("\n❌ Error generating composition")